 ...
 * </p>
 * <p>
 * The basic mechanism of this class is to overload the <code>write()</code>
 * method for most of the
 * Eressea base classes. Since many blocks and tags come in bunches there are
 * helper functions for
 * each such sequence handling the collections in which the data objects are
 * stored in.
 * </p>
 */
public class CRWriter extends BufferedWriter {
  ...
  private String encoding = "UTF-8"; // Default changed from ISO-8859-1
  ...
  /**
   * Remove quotes from text and replace blanks whithin the quoted section with ~
   * characters. ("a
   * \"b c\"" &rarr; "a b~c")
   *
   * @param text the string to be modified.
  ...
  /**
   * Write the String <kbd>str</kbd> quoted to the underlying stream. If a part of
   * <kbd>str</kbd> is
  ...
  /**
   * Write the String <kbd>str</kbd> quoted along with the specified tag to the
   * underlying stream. If
   * a part of <kbd>str</kbd> is quoted, its quotes are escaped according to the
   * current quote escape
   ...
   * @param key   the tag to be written to the stream, separated from
   *              <kbd>str</kbd> by a semicolon.
   * @throws IOException If an I/O error occurs.
   */
  ...
  /**
   * Write the cr representation of a <kbd>Message</kbd> object to the underlying
   * stream.
   *
   * @throws IOException If an I/O error occurs.
   */
  ...
  /**
   * Write the data as one block named <kbd>blockName</kbd> to the underlying
   * stream. The data is
   * written as simple cr strings. The block name is only written if there is data
   * to follow.
   *
   * @param blockName the name of the block to be written (can not be a block with
   *                  an id).
   ...
   * [PATCH V.1.0.2] Re-injects section tags to preserve colors in Magellan 2.x
   */
  public void writeMessageSequence(Collection<Message> data) throws IOException {
    ...
    for (Message msg : data) {
      ...
      // 1. Try direct attribute (This should now work thanks to CRParser fix)
      section = msg.getAttribute("section");

      // 2. Try MessageType (Fallback)
      if (section == null && msg.getMessageType() != null) {
        section = msg.getMessageType().getSection();
      }

      // Inject XML tag if section is found
      if (section != null && text != null) {
        if (!text.startsWith("<tag>")) {
          text = "<tag>" + section + "</tag>" + text;
        }
      }
  ...
  public void writeVersion(GameData world) throws IOException {
    log.debug("Writing VERSION block (Start of file)...");
    log.debug("Encoding used for header: " + encoding);
  ...
  /**
   * Write the cr representation of a <kbd>Spell</kbd> object to the underlying
   * stream.
   *
   * @throws IOException If an I/O error occurs.
   */
  ...
  /**
   * Write the cr representation of a <kbd>Potion</kbd> object to the underlying
   * stream.
   *
   * @throws IOException If an I/O error occurs.
   */
  ...
  /**
   * Write a spell components (KOMPONENTEN) block to the underyling. The block
   * name is only written,
   ...
   *              names of the components as keys and the component data as values
   *              (both as
   *              <kbd>String</kbd> objects). Such a map can be found in the
   *              <kbd>Spell</kbd> class.
   * @throws IOException If an I/O error occurs.
  ...
  /**
   * Write the cr representation of a <kbd>Option</kbd> object to the underlying
   * stream.
   *
   * @throws IOException If an I/O error occurs.
   */
   ...
   *            <kbd>Integer</kbd>
   *            objects containing the ids of the alliances. The values are
   *            expected to be instances
  ...
  /**
   * Write the cr representation of a <kbd>Group</kbd> object to the underlying
   * stream.
   *
   * @throws IOException If an I/O error occurs.
   */
   ...
   *
   * @param map a map containing the alliances to write. The keys are expected to
   *            be
   *            <kbd>Integer</kbd> objects containing the ids of the alliances.
   *            The values are expected
   *            to be instances of class <kbd>Alliance</kbd>. May be
   *            <code>null</code>.
   * @throws IOException If an I/O error occurs.
   */
  ...
  /**
   * Write the cr representation of an <kbd>Alliance</kbd> object to the
   * underlying stream.
   *
   * @throws IOException If an I/O error occurs.
   */
   ...
   *
   * @param list a list containing the <kbd>Battle</kbd> objects to be written. My
   *             be
   *             <code>null</code>.
   * @throws IOException If an I/O error occurs.
   */
  ...
  /**
   * Write the cr representation of a <kbd>Battle</kbd> object to the underlying
   * stream.
   *
   * @throws IOException If an I/O error occurs.
   */
  ...
  /**
   * Write the cr representation of a <kbd>Faction</kbd> object to the underlying
   * stream.
   *
   * @throws IOException If an I/O error occurs.
   */
  ...
  /**
   * Write the cr representation of a <kbd>Ship</kbd> object to the underlying
   * stream.
   *
   * @throws IOException If an I/O error occurs.
   */
   ...
   *
   * @param buildings an iterator containing the<kbd>Building</kbd> objects to be
   *                  written.
   * @throws IOException
   */
  ...
  /**
   * Write the cr representation of a <kbd>Building</kbd> object to the underlying
   * stream.
   *
   * @throws IOException If an I/O error occurs.
   */
  ...
  /**
   * Write a skills (TALENTE) block to the underlying stream. The block is only
   * written, if
  ...
  /**
   * Write the cr representation of a <kbd>Skill</kbd> object to the underlying
   * stream.
   *
   * @throws IOException If an I/O error occurs.
   */
  ...
  /**
   * Write a COMMANDS block to the underlying stream. The block is only written,
   * if <kbd>list</kbd>
  ...
  /**
   * Write a unit's spell (SPRUECHE) block to the underlying stream. The block is
   * only written, if
  ...
  /**
   * Write the cr representation of a <kbd>CombatSpell</kbd> object to the
   * underlying stream.
   *
   * @throws IOException If an I/O error occurs.
   */
  ...
  /**
   * Write a unit's items (GEGENSTAENDE) block to the underlying stream. The block
   * is only written,
  ...
  /**
   * Write the cr representation of a <kbd>Item</kbd> object to the underlying
   * stream.
   *
   * @throws IOException If an I/O error occurs.
   */
  ...
  /**
   * Write a sequence of old unit (ALTEINHEIT) blocks for the given region to the
   * underlying stream.
   *
   * @throws IOException If an I/O error occurs.
   */
  ...
  /**
   * Write the cr representation of a <kbd>LuxuryPrice</kbd> object to the
   * underlying stream.
   *
   * @throws IOException If an I/O error occurs.
   */
  ...
  /**
   * Write the cr representation of a <kbd>Border</kbd> object to the underlying
   * stream.
   *
   * @throws IOException If an I/O error occurs.
   */
  ...
  /**
   * Write the cr representation of a <kbd>Region</kbd> object to the underlying
   * stream.
   *
   * @throws IOException If an I/O error occurs.
   */
  ...
  /**
   * Writes the cr representation of a region resource object to the underlying
   * stream.
   *
   * @throws IOException If an I/O error occurs.
   */
   ...
   *
   * @param map a map containing the <kbd>MessageType</kbd> objects to be written
   *            as values.
   * @throws IOException If an I/O error occurs.
   */
  ...
  /**
   * Write the cr representation of a <kbd>MessageType</kbd> object to the
   * underlying stream.
   *
   * @throws IOException If an I/O error occurs.
   */
    ...
    t = new Thread(new Runnable() {
      ...
      public void run() {
        try {
          ...
          // FIXME (stm) we close here /and/ in the calling method. Should make up our
          // mind's what
          // to do where
          try {
            close(true);
  ...
  /**
   * Write the complete game data from <kbd>world</kbd> in the cr format. This
  ...
  /**
   * Change the quote escape behaviour of this CRWriter. Tilde escapes look like:
   * 'a "b c"' &rarr; 'a
   * b~c', whereas a backslash escape works like this: 'a "b c"' &rarr; 'a \"b
   * c\"'
   *
   * @param bool if <kbd>true</kbd>, escape quoted parts of any string written to
   *             the underlying
   *             stream with tildes. If <kbd>false</kbd>, use backslash character
   *             to escape the quotation
   *             marks themselves.
   */
  ...
  /**
   * Returns whether {@link #doWrite()} writes information about the regions in
   * data to the
   * underlying stream.
   */
  ...
  /**
   * Toggles whether {@link #doWrite()} writes information about the regions in
   * data to the
   * underlying stream.
   */
  ...
  /**
   * Returns whether {@link #doWrite()} writes information about the buildings in
   * data to the
   * underlying stream.
   */
  ...
  /**
   * Toggles whether {@link #doWrite()} writes information about the buildings in
   * data to the
   * underlying stream.
   */
  ...
  /**
   * Returns whether {@link #doWrite()} writes information about the ships in data
   * to the underlying
   * stream.
   */
  ...
  /**
   * Toggles whether {@link #doWrite()} writes information about the ships in data
   * to the underlying
   * stream.
   */
  ...
  /**
   * Returns whether {@link #doWrite()} writes information about the units in data
   * to the underlying
   * stream.
   */
  ...
  /**
   * Toggles whether {@link #doWrite()} writes information about the units in data
   * to the underlying
   * stream.
   */
  ...
  /**
   * Toggles whether {@link #doWrite()} writes information about the unit skills
   * in data to the
   * underlying stream.
   *
   * @param newValue
  ...
  /**
   * Toggles whether {@link #doWrite()} writes the units' orders in data to the
   * underlying stream.
   *
   * @param newValue
   */
  ...
  /**
   * Returns whether {@link #doWrite()} writes detailed information about the
   * regions in data to the
   * underlying stream.
   */
  ...
  /**
   * Toggles whether {@link #doWrite()} writes detailed information about the
   * regions in data to the
   * underlying stream.
   */
  ...
  /**
   * Returns whether {@link #doWrite()} writes information about islands to the
   * underlying stream.
   */
  ...
  /**
   * Toggles whether {@link #doWrite()} writes information about islands to the
   * underlying stream.
   */
  ...
  /**
   * Returns whether {@link #doWrite()} writes messages contained in the game data
   * to the underlying
   * stream.
   */
  ...
  /**
   * Toggles whether {@link #doWrite()} writes messages contained in the game data
   * to the underlying
   * stream.
   */
  ...
  /**
   * Returns whether {@link #doWrite()} writes Hotspots contained in the game data
   * to the underlying
   * stream.
   */
  ...
  /**
   * Toggles whether {@link #doWrite()} writes Hotspots contained in the game data
   * to the underlying
   * stream.
   */
  ...
  /**
   * Returns whether {@link #doWrite()} writes a cr that is compatible with cr's
   * generated by the
  ...
  /**
   * Toggles whether {@link #doWrite()} writes a cr that is compatible with cr's
   * generated by the
   * Eressea server, i.e. not including JavaClient specific data.
   */
  ...
  /**
   * Write the cr representation of an <kbd>Island</kbd> object to the underlying
   * stream.
   *
   * @throws IOException If an I/O error occurs.
   */
   ...
   * of all regions contained in the game data. If regions is null or if there is
   * no element in the
   * supplied collection, the writer returns to writing all regions defined in the
   * game data.
   */
  ...
  /**
   * Supply the writer with a collection of units it should write to the
   * underlying stream instead
   * of all units contained in the game data. If units is null or if there is no
   * element in the
   * supplied collection, the writer returns to writing all units defined in the
   * game data.
   */
